...
int main(void)
{
    ...
    eUSCI_UART_Config uartConfig = {
         ...
         8,                                            // UCBRF  = 8 //modulo 16
         0x55,                                         // UCBRS  = 0x55 //modulation pattern decided by the fraction part
    ...
    while(1)
    {
        ...
        if (UART_getInterruptStatus (EUSCI_A0_BASE, EUSCI_A_UART_TRANSMIT_INTERRUPT_FLAG) == EUSCI_A_UART_TRANSMIT_INTERRUPT_FLAG && charAvail == true) {
